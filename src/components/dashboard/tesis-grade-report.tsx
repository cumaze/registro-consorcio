...
export function TesisGradeReport({ student, counselorSignature, secretarySignature, coordinatorSignature, thesisGrade }: TesisGradeReportProps) {
  ...
  return (
    <div className="p-8 bg-white text-gray-800 font-serif text-lg leading-relaxed">
      ...
      <p>
        Dado en la ciudad de {student.city}, a los {new Date().toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}.
      </p>
