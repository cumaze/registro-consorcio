...
export function MainDashboard({ student, courses, onReset, onBackToList, logoUrl, universityName, counselorSignature, secretarySignature, coordinatorSignature, onEditCourse }: MainDashboardProps) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center bg-gray-100 p-4 md:p-8 font-sans">
      ...
      <div ref={reportRef} className="w-full max-w-7xl bg-white shadow-2xl p-4" style={{ minWidth: '1024px', minHeight: '297mm'}}>
        <div className="flex justify-between items-center border-b-4 border-blue-900 pb-2 mb-2">
            ...
            <h1 className="text-4xl font-bold text-blue-900 font-serif tracking-wider">{universityName}</h1>
