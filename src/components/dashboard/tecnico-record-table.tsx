...
export function TecnicoRecordTable({ records, student, onAverageCalculated, thesisGrade, onEditCourse }: TecnicoRecordTableProps) {
  const totalRows = 33;
