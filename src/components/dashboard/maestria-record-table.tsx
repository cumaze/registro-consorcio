...
import { inductionCourses, maestriaCursosBasicos, professionalCourses } from "@/lib/academic-data";
            ...
            <div className="col-span-12 p-0">
                 <Table>
                    ...
                    <TableBody>
                        ...
                        {renderCourses(specializationCourses, "Cursos de Especialización", true)}
